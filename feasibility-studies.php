...
if (isset($_GET['category'])) {
    $catid = $_GET['category'];
    $where = 'WHERE feasibility.fs_type = ' . $catid;
}
...
<head>
    ...
    <title>Library Holdings | Unpublished Materials - Feasibility Studies</title>
        ...
        function getRow(id) {
            $.ajax({
                ...
                success: function (response) {
                    $('.fsid').val(response.fsid);
                    $('#catselect').val(response.fs_type).html(response.name);
