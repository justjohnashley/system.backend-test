...
if (isset($_GET['category'])) {
    $catid = $_GET['category'];
    $where = 'WHERE nreport.nr_type = ' . $catid;
}
...
<head>
    ...
    <title>Library Holdings | Unpublished Materials - Narrative Reports</title>
        ...
        function getRow(id) {
            $.ajax({
                ...
                success: function (response) {
                    $('.nrid').val(response.nrid);
                    $('#catselect').val(response.nr_type).html(response.name);
...
<script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var cpCoverModal = document.getElementById('nrcover');
            cpCoverModal.addEventListener('show.bs.modal', function (event) {
                var triggerElement = event.relatedTarget;
                var capCover = triggerElement.getAttribute('data-nreport-cover');
