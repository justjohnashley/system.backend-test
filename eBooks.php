...
<head>
    ...
    <title>Library Holdings | Published Materials - eBooks</title>
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <div class="row">
                        ...
                        <div class="card border-success flex-fill border-3 illustration">
                            <div class="card-body text-light p-0 d-flex flex-fill">
                                <div class="row g-0 w-100">
                                    <div class="col-8">
                                        <div class="p-4 m-1">
                                            <h4>List of eBooks</h4>
                                        </div>
                                    </div>
                                    <div class="col-4 align-self-center text-center">
                                        <a href="eb_add" class="btn btn-secondary px-5" data-bs-toggle="modal"
                                            data-bs-target="#eb_add">
                    ...
                    <?php include 'modal/ebook-add.php' ?>
                                    ...
                                    <div class="row g-0 w-100">
                                        <div class="table-responsive-xl">
                                            <table id="libtable" class="table table-hover table-striped"
                                                ...
                                                <?php include 'ebooks-content.php' ?>
