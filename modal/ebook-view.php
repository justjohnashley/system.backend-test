...
$sql = "SELECT id, content FROM ebooks";
$query = $con->query($sql);
...
if ($query->num_rows > 0) {
 ...
 ?>
        ...
        <div class="modal fade" id="eb_view<?php echo $ebookId; ?>" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel<?php echo $ebookId; ?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="viewModalLabel<?php echo $ebookId; ?>">View</h4>
                    ...
                    <div class="modal-body">
                        ...
                        if (!empty($content_files) && is_array($content_files)) {
                            ...
                            echo '<p>No content uploaded for this ebook.</p>';
                        }
                        ?>
                    </div>
                </div>
