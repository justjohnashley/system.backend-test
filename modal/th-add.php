...
<div class="modal fade" id="thadd">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="validation" name="add" action="t_add.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="container overflow-hidden">
                        <div class="row gy-2">
                            ...
                            <div class="col-12">
                                <label for="captitle" class="form-label">Thesis Title</label>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="thcode" name="code" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control is-invalid" id="imageUpload"
                                        name="th_cover" accept=".jpg, .jpeg, .png" data-bs-toggle="tooltip"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="th-add">Submit</button>
                </div>
