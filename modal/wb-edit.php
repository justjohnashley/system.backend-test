...
<div class="modal fade" id="wbedit">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form name="edit" action="wb_edit.php" method="POST">
                ...
                <div class="modal-body">
                    <div class="container overflow-hidden">
                        <div class="row gy-2">
                            ...
                            <div class="col-12">
                                <label for="edit_title" class="form-label">Workbook Title</label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="wb-edit">Submit</button>
                </div>
